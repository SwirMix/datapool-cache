...
public class DataImportService {
    ...
    private ConcurrentHashMap<String, Future<CsvImportStatus>> importFutures = new ConcurrentHashMap<>();
    ...
    public ConcurrentHashMap<String, Future<CsvImportStatus>> getAllFutures(){
    ...
    public String importCacheToCsv(String cacheName, String fileName, String project){
        ...
        Future<CsvImportStatus> future = executorService.submit(new ImportCsvFuture(fileName, metadata.getColumns(), ignite.cache(cacheName), project));
